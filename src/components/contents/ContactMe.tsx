...
// ← EmailJS import is GONE. No more emailjs-com.
...
const ContactMe = () => {
    ...
    const { mutate: handleSubmit, isPending: isLoading } = useMutation({
        mutationFn: async ({
            ...
            // ← REPLACED EmailJS with a fetch call to our Resend API route
        ...
        <AnimationContainer customClassName='w-full py-12 lg:py-16'>
            ...
            <div className="flex flex-col items-center justify-center w-full">
                <div className="flex flex-col items-center justify-center w-full gap-5 mb-8 lg:flex-row">
                    <Link href="mailto:arhamaqeel43@gmail.com" className="flex-[0.5] w-full lg:w-auto">
                        <Button type='button' variant="outline" className="flex-col items-start w-full h-auto p-5 hover:scale-100">
                            ...
                            <p className="mt-2 text-base text-muted-foreground">
                                arhamaqeel43@gmail.com
                            </p>
                        </Button>
                    </Link>
                    <Link href="https://wa.me/+918090061797" className="flex-[0.5] w-full lg:w-auto">
                        <Button type='button' variant="outline" className="flex-col items-start w-full h-auto p-5 hover:scale-100">
                            <h6 className="text-base font-medium text-foreground">
                                WhatsApp
                            </h6>
